...
async function main(network) {
    ...
    const Zoracles = await ethers.getContractFactory('Zoracles');
    const zoracles = await Zoracles.deploy();
    await zoracles.deployed();

    console.log('Zoracles deployed to:', zoracles.address);
    ...
    // await marketplace.initialize(TREASURY_ADDRESS, PLATFORM_FEE, REWARD_TOKEN_ADDR, TREASURY_ADDRESS, XANA_ADDRESS_REGISTRY);
    ...
    // await bundleMarketplace.initialize(TREASURY_ADDRESS, PLATFORM_FEE, REWARD_TOKEN_ADDR, TREASURY_ADDRESS, XANA_ADDRESS_REGISTRY);
    ...
    // await auction.initialize(TREASURY_ADDRESS, REWARD_TOKEN_ADDR, TREASURY_ADDRESS, XANA_ADDRESS_REGISTRY);
